    ...
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="https://flowbite.com/" class="flex items-center">
                <img src="../../img/logo/logo.png" class="mr-3 h-8" alt="AtelierDS Logo"  style={{height:50, width:50}}></img>
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AtelierDS</span>
            </a>
        </div>
